...
func TestDeleteHandler(t *testing.T) {
	...
	_, err = store.GetEvent(context.Background(), "111")
...
func TestGetListOnDateHandler(t *testing.T) {
	var output bytes.Buffer
	...
	startDt1, err := time.Parse(time.DateOnly, "2024-06-01")
	if err != nil {
		t.Fatal(err)
	}

	endDt1, err := time.Parse(time.DateOnly, "2024-06-10")
	if err != nil {
		t.Fatal(err)
	}

	startDt2, err := time.Parse(time.DateOnly, "2024-06-12")
	if err != nil {
		t.Fatal(err)
	}

	endDt2, err := time.Parse(time.DateOnly, "2024-06-15")
	if err != nil {
		t.Fatal(err)
	}
	...
	r := httptest.NewRequest(
		"POST",
		"http://localhost:8080/event/listOnDate?date=2024-06-01",
		nil,
	)

	w := httptest.NewRecorder()
	server.GetListOnDateHandler(w, r)
	...
	require.Equal(
		t,
		//nolint: all
		"[{\"id\":\"1\",\"title\":\"Test\",\"description\":\"\",\"start_dt\":\"2024-06-01T00:00:00Z\",\"end_dt\":\"2024-06-10T00:00:00Z\",\"creator_id\":1,\"notify_before\":172800000000000}]",
		buf.String(),
	)
}

func TestGetListOnWeekHandler(t *testing.T) {
	var output bytes.Buffer
	...
	startDt1, err := time.Parse(time.DateOnly, "2024-06-04")
	if err != nil {
		t.Fatal(err)
	}

	endDt1, err := time.Parse(time.DateOnly, "2024-06-06")
	if err != nil {
		t.Fatal(err)
	}
	...
	w := httptest.NewRecorder()
	server.GetListOnWeekHandler(w, r)
	...
	require.Equal(
		t,
		//nolint: all
		"[{\"id\":\"1\",\"title\":\"Test\",\"description\":\"\",\"start_dt\":\"2024-06-04T00:00:00Z\",\"end_dt\":\"2024-06-06T00:00:00Z\",\"creator_id\":1,\"notify_before\":172800000000000}]",
		buf.String(),
	)
}

func TestGetListOnMonthHandler(t *testing.T) {
	var output bytes.Buffer
	...
	startDt1, err := time.Parse(time.DateOnly, "2024-06-14")
	if err != nil {
		t.Fatal(err)
	}

	endDt1, err := time.Parse(time.DateOnly, "2024-06-19")
	if err != nil {
		t.Fatal(err)
	}

	startDt2, err := time.Parse(time.DateOnly, "2024-07-12")
	if err != nil {
		t.Fatal(err)
	}

	endDt2, err := time.Parse(time.DateOnly, "2024-07-15")
	if err != nil {
		t.Fatal(err)
	}
	...
	w := httptest.NewRecorder()
	server.GetListOnMonthHandler(w, r)
	...
	require.Equal(
		t,
		//nolint: all
		"[{\"id\":\"1\",\"title\":\"Test\",\"description\":\"\",\"start_dt\":\"2024-06-14T00:00:00Z\",\"end_dt\":\"2024-06-19T00:00:00Z\",\"creator_id\":1,\"notify_before\":172800000000000}]",
		buf.String(),
	)
}
